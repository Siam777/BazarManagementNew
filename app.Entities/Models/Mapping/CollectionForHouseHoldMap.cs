...
{
    class CollectionForHouseHoldMap : EntityTypeConfiguration<CollectionForHouseHold>
    {
        public CollectionForHouseHoldMap(){

        this.HasKey(t => t.Id);

            // Table & Column Mappings
            this.ToTable("CollectionForHouseHold");
            ...
            this.HasRequired(t => t.Institute)
                 .WithMany(t => t.CollectionForHouseHold)
